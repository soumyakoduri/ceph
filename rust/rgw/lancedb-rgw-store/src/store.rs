...
use crate::ffi::{self, OwnedRGWBuffer, OwnedRGWListResult, OwnedRGWObjectMeta, RGWObject};
...
pub struct RGWObjectStore {
    ...
    bucket: String,
    /// Path prefix for debugging/logging
    prefix: String,
    /// Chunk size for streaming reads, from rgw_max_chunk_size
    chunk_size: u64,
}
