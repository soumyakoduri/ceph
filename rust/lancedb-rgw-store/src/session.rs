...
//=============================================================================
// Primary API - Used by Ceph via FFI
//=============================================================================

/// Create an ObjectStoreRegistry with RGW provider
///
/// This is the primary function used by Ceph via FFI (ceph_lancedb_create_registry).
/// It creates an ObjectStoreRegistry with the "s3" scheme overridden to use
/// RGWStoreProvider, routing all s3:// URLs through RGW's SAL API.
///
/// # Safety
...
///
/// # Returns
/// An Arc-wrapped ObjectStoreRegistry ready to be passed to lancedb_session_new_with_registry()
...
//=============================================================================
// Helper Functions - Not currently used by Ceph
//
// These functions are provided as convenience helpers for Rust-native usage
// or future integration. Currently, Ceph uses the lancedb-c API directly
// with the registry created by create_rgw_registry() above.
//=============================================================================
