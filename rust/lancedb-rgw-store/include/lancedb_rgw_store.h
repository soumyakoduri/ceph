 ...
 */
typedef void RGWLanceDBRegistry;
 ...
 * @endcode
 */
RGWLanceDBRegistry* rgw_lancedb_create_registry(void* driver, const void* dpp);
 ...
 */
void rgw_lancedb_registry_free(RGWLanceDBRegistry* registry);
 ...
 */
size_t rgw_lancedb_default_index_cache_size(void);
 ...
 */
size_t rgw_lancedb_default_metadata_cache_size(void);
