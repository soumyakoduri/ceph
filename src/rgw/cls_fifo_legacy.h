...
public:
  ...
  int get_head_info(fifo::info* info, //< OUT: Since we're fetching it
				      //< anyway, may as well give it
				      //< to the caller. May be null.
		    fifo::part_header* header, //< OUT: Head information
		    lr::AioCompletion* c //< AIO Completion
    );
