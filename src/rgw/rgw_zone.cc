...
void RGWZoneGroupPlacementTier::decode_json(JSONObj *obj)
{
  ...
  JSONDecoder::decode_json("cloud_restore_object_hold_days", cloud_restore_object_hold_period, obj);
...
void RGWZoneGroupPlacementTier::dump(Formatter *f) const
{
  ...
  encode_json("cloud_restore_object_hold_days", cloud_restore_object_hold_period, f);
